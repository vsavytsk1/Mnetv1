...
FEATURED_FAMILIES = [
    ...
    ("kibotos",         "KIBOTOS-100 -- THE HUNDRED-YEAR BOX", "please stop boiling water, bro. a first-principles engineering scroll: a sealed 100W-for-a-century socket, no moving parts. the isotope ledger (chemistry excluded by 10^3; Ni-63 half-life = 101 years = the warranty), and the phi^2-chirped optical mirror that beats periodic + Fibonacci stacks (weighted R = 0.9999) -- its bandwidth IS the light matrix's growth eigenvalue. golden trace recursion x_{n+1}=2x_n x_{n-1}-x_{n-2}, invariant conserved to 50+ digits. the no-equal-sign law, audited at build. a core focus."),
