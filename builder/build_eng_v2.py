...
FEATURED_FAMILIES = [
    ...
    ("genesis_v8_2",    "GENESIS v8.2",   "the fractal space explorer, now with THE GOLDEN CATALOGUE: seed the next 7 buckyballs C20->C60->C140->C380->C980->C2580->C6740 (Goldberg-Coxeter, Thea Lane B -- each kernel-CERTIFIED V=20T E=30T P=12 chi=2, all-trivalent, C6740 forged live in the browser). the FLIGHT EXPLORER locks every point on seed and centers any pentagon/vertex front-and-center on click. seed a Platonic solid, refine the buckyball, fly INSIDE. M1-M6 kernel live."),
