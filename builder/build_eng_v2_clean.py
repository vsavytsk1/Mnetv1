...
function summon(key) {
  ...
  if (NEW_TAB_MODULES[key]) {
    ...
    // Curse 11 fix: use portal.html (same origin) NOT srcdoc (cross-origin freeze)
    var shortUrl = LINKS[key].replace('https://vsavytsk1.github.io/Mnetv1/','');
    fr.src = 'https://vsavytsk1.github.io/Mnetv1/shell/portal.html?url=' + encodeURIComponent(shortUrl);
    return;
  }
