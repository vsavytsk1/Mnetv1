...
<div id="main">
  ...
  <div id="center">
    ...
    <div class="mod-grid">
      ...
      <div class="mod-card new-module" id="card-valtium" onclick="summon('valtium')" style="border-color:#2a1a3a;--cc:#c084fc">
        <div class="card-dot" id="dot-valtium" title="toggle module"></div>
        <div class="card-tag" style="color:#c084fc">THE VAULT</div>
        <div class="card-name" style="color:#c084fc">VALTIUM v1.0</div>
        <div class="card-desc">THE MACHINE . P1-P12 . chi=2 . find the pentagons in the research</div>
        <div class="card-arrow" style="color:#c084fc">SUMMON &gt;</div>
      </div>
...
<div id="mod-selector">
  ...
  <div class="ms-row" onclick="toggleMod('valtium')"><span class="ms-name">VALTIUM v1.0</span><span class="ms-dot on" id="ms-valtium"></span></div>
</div>
<div id="overlay">
  <div id="ov-bar">
...
var LINKS = {
  ...
  valtium   : 'https://vsavytsk1.github.io/Mnetv1/shell/valtium_v1.html'
...
function summon(key) {
  ...
  if (NEW_TAB_MODULES[key]) {
    ...
    fr.srcdoc = '<html><body style="margin:0;background:#050510;display:flex;'
      ...
      + 'font-family:ui-monospace,monospace;flex-direction:column;gap:16px">'
      + '<div style="color:#00d4ff;font-size:11px;letter-spacing:0.18em;opacity:0.5">'
      + 'LAUNCHED IN NEW TAB</div>'
      + '<div style="color:#1a3a3a;font-size:9px;letter-spacing:0.1em">'
      + shortUrl + '</div>'
      + '<div style="color:#00d4ff;font-size:28px;opacity:0.2">&#8599;</div>'
      + '</body></html>';
    return;
  }
...
var ALL_MODS = ['genesis','sandbox','tree','holly7','navier','warning',
                'license','gkern','vale','spooky','obsidius','valtium'];
var modState = {};
