...
window.addEventListener('load', function() {
  ...
  drawLines();
  console.log('[JARVIS] all 6 modules loaded and rendered');
});
...
"""
TITLE = "JARVIS OS . MachineNet " + VERSION
HTML = (
...
print("[OK] https://vsavytsk1.github.io/Mnetv1/shell/jarvis_v1.0.html")
